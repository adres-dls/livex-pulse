...
- **Adrec theme** is active via `<html data-brand="adrec">`. Palette: primary=gold, secondary=sage, accent=burgundy, neutral=grey. Typeface: Helvetica Neue (system). Dark mode = `.dark` class on `<html>`.
